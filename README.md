...
**Hello React Frontend** is an App that displays random predefined greetings and works for getting familiar with Full-stacks applications mixing React and Redux with the Server side consuming an rails API.
...
> git clone git@github.com:angeluray/hello-react-front-end.git
